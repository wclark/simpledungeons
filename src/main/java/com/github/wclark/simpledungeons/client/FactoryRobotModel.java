...
public class FactoryRobotModel extends EntityModel<FactoryRobotEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("right_axe_handle", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-0.45F, -7.5F, -0.45F, 0.9F, 16.0F, 0.9F), PartPose.offsetAndRotation(-8.8F, 12.0F, -1.7F, 0.0F, 0.0F, 0.12F));
        ...
        root.addOrReplaceChild("right_axe_head", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-2.6F, -2.6F, -0.8F, 2.7F, 4.8F, 1.6F)
                .texOffs(0, 0).addBox(0.0F, -1.3F, -0.8F, 1.8F, 2.4F, 1.6F), PartPose.offsetAndRotation(-9.4F, 4.2F, -1.7F, 0.0F, 0.0F, 0.12F));
        root.addOrReplaceChild("left_axe_head", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-0.1F, -2.6F, -0.8F, 2.7F, 4.8F, 1.6F)
                .texOffs(0, 0).addBox(-1.8F, -1.3F, -0.8F, 1.8F, 2.4F, 1.6F), PartPose.offsetAndRotation(9.4F, 4.2F, -1.7F, 0.0F, 0.0F, -0.12F));
        root.addOrReplaceChild("right_axe_edge", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-3.0F, -1.6F, -0.95F, 0.7F, 2.8F, 1.9F), PartPose.offsetAndRotation(-9.4F, 4.2F, -1.7F, 0.0F, 0.0F, 0.12F));
        root.addOrReplaceChild("left_axe_edge", CubeListBuilder.create()
                .texOffs(0, 0).addBox(2.3F, -1.6F, -0.95F, 0.7F, 2.8F, 1.9F), PartPose.offsetAndRotation(9.4F, 4.2F, -1.7F, 0.0F, 0.0F, -0.12F));
